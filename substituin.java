...
class Truck extends Vehicle {
    ...
    public void accelerate(double speed) {
        ...
        if (speed <= maxSpeed) {
            System.out.println(
                    getVehicleInfo() + " accelerating to " + speed + " km/h (heavy acceleration due to weight).");
    ...
    public void loadCargo(double weight) {
        if (currentCargo + weight <= cargoCapacity) {
            currentCargo += weight;
            System.out.println(getVehicleInfo() + " loaded " + weight + " tons. Current cargo: " + currentCargo + "/"
                    + cargoCapacity + " tons.");
        } else {
    ...
    public void unloadCargo(double weight) {
        if (currentCargo >= weight) {
            currentCargo -= weight;
            System.out.println(getVehicleInfo() + " unloaded " + weight + " tons. Current cargo: " + currentCargo + "/"
                    + cargoCapacity + " tons.");
        } else {
...
class ElectricCar extends Vehicle {
    ...
    public void refuel(double amount) {
        ...
        fuelLevel = (batteryLevel / batteryCapacity) * 100;
        System.out.println(
                getVehicleInfo() + " charged. Current battery level: " + String.format("%.1f", fuelLevel) + "%");
    }
